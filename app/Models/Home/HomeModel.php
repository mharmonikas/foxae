...
class HomeModel extends Model{
	...
	public function getautorenewpackage($timestamp){
		$result = DB::table('tbl_buypackage')->where('package_start_time','<',$timestamp)->whereNotNull('package_start_time')->leftjoin('tbl_plan','tbl_buypackage.buy_id','tbl_plan.plan_id')->where('tbl_buypackage.package_subscription','!=','N')->where('tbl_buypackage.status','A')->get();
		return $result;
	}
	/* public function getautorenewpackage($timestamp){
