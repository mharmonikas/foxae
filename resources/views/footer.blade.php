...
<div class="container">
		<div class="footer">
			<div class="f-left">
				<h3>  Share </h3>
				<ul>
					<li><a href="#"><svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
						<path d="M21.8337 11C21.8337 5.01996 16.9803 0.166626 11.0003 0.166626C5.02033 0.166626 0.166992 5.01996 0.166992 11C0.166992 16.2433 3.89366 20.6091 8.83366 21.6166V14.25H6.66699V11H8.83366V8.29163C8.83366 6.20079 10.5345 4.49996 12.6253 4.49996H15.3337V7.74996H13.167C12.5712 7.74996 12.0837 8.23746 12.0837 8.83329V11H15.3337V14.25H12.0837V21.7791C17.5545 21.2375 21.8337 16.6225 21.8337 11Z" fill="#5B5C5C"/></svg>Facebook</a></li>
					<li><a href="#"><svg width="20" height="10" viewBox="0 0 20 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15 0H12C11.45 0 11 0.45 11 1C11 1.55 11.45 2 12 2H15C16.65 2 18 3.35 18 5C18 6.65 16.65 8 15 8H12C11.45 8 11 8.45 11 9C11 9.55 11.45 10 12 10H15C17.76 10 20 7.76 20 5C20 2.24 17.76 0 15 0ZM6 5C6 5.55 6.45 6 7 6H13C13.55 6 14 5.55 14 5C14 4.45 13.55 4 13 4H7C6.45 4 6 4.45 6 5ZM8 8H5C3.35 8 2 6.65 2 5C2 3.35 3.35 2 5 2H8C8.55 2 9 1.55 9 1C9 0.45 8.55 0 8 0H5C2.24 0 0 2.24 0 5C0 7.76 2.24 10 5 10H8C8.55 10 9 9.55 9 9C9 8.45 8.55 8 8 8Z" fill="#5B5C5C"/></svg>Copy Link</a></li>
					<li><a href="#"><svg width="21" height="17" viewBox="0 0 21 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.77289 16.7344C14.3329 16.7344 18.4541 10.3859 18.4541 4.91406C18.4541 4.72813 18.4541 4.54219 18.4541 4.38281C19.2679 3.79844 19.9504 3.05469 20.5016 2.23125C19.7666 2.55 18.9791 2.78906 18.1391 2.89531C18.9791 2.39062 19.6354 1.56719 19.9504 0.584375C19.1629 1.0625 18.2704 1.40781 17.3516 1.59375C16.5904 0.770313 15.5404 0.265625 14.3591 0.265625C12.0754 0.265625 10.2379 2.125 10.2379 4.43594C10.2379 4.75469 10.2641 5.07344 10.3429 5.39219C6.93039 5.20625 3.91164 3.55938 1.86414 1.03594C1.52289 1.64688 1.31289 2.36406 1.31289 3.10781C1.31289 4.54219 2.04789 5.81719 3.15039 6.56094C2.46789 6.53438 1.83789 6.34844 1.28664 6.02969C1.28664 6.05625 1.28664 6.05625 1.28664 6.08281C1.28664 8.10156 2.70414 9.775 4.59414 10.1469C4.25289 10.2531 3.88539 10.3062 3.51789 10.3062C3.25539 10.3062 2.99289 10.2797 2.75664 10.2266C3.28164 11.8734 4.80414 13.0688 6.58914 13.1219C5.17164 14.2375 3.41289 14.9016 1.49664 14.9016C1.15539 14.9016 0.840391 14.875 0.525391 14.8484C2.31039 16.0438 4.46289 16.7344 6.77289 16.7344Z" fill="#5B5C5C"/></svg>Twitter</a></li>
					<li><a href="#"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 4H4C2.9 4 2.01 4.9 2.01 6L2 18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6C22 4.9 21.1 4 20 4ZM19.6 8.25L12.53 12.67C12.21 12.87 11.79 12.87 11.47 12.67L4.4 8.25C4.15 8.09 4 7.82 4 7.53C4 6.86 4.73 6.46 5.3 6.81L12 11L18.7 6.81C19.27 6.46 20 6.86 20 7.53C20 7.82 19.85 8.09 19.6 8.25Z" fill="#5B5C5C"/></svg>Email</a></li>
				</ul>
			</div>
			<div class="f-right">
			<h3> Navigate </h3>
	...
	<div class="side_section">
		...
		@foreach($Plans  as $plansecond)
			...
			<li style="clear: both" class="">
				...
				<label for="f-{{$plansecond->plan_id}}"><p class="plan-name">{{ $plansecond->plan_name }}</p>
