                        ...
                        <div class="main-icon">
                            <ul>
                                ...
                                <li class="popup-dropdown link-list">
                                    <a id="sharenavbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M24.75 22.11C23.705 22.11 22.77 22.5225 22.055 23.1688L12.2512 17.4625C12.32 17.1463 12.375 16.83 12.375 16.5C12.375 16.17 12.32 15.8538 12.2512 15.5375L21.945 9.88625C22.6875 10.5738 23.6637 11 24.75 11C27.0325 11 28.875 9.1575 28.875 6.875C28.875 4.5925 27.0325 2.75 24.75 2.75C22.4675 2.75 20.625 4.5925 20.625 6.875C20.625 7.205 20.68 7.52125 20.7488 7.8375L11.055 13.4888C10.3125 12.8013 9.33625 12.375 8.25 12.375C5.9675 12.375 4.125 14.2175 4.125 16.5C4.125 18.7825 5.9675 20.625 8.25 20.625C9.33625 20.625 10.3125 20.1988 11.055 19.5113L20.845 25.2313C20.7762 25.52 20.735 25.8225 20.735 26.125C20.735 28.3388 22.5362 30.14 24.75 30.14C26.9638 30.14 28.765 28.3388 28.765 26.125C28.765 23.9113 26.9638 22.11 24.75 22.11Z" fill="#5B5C5C"/>
                                        </svg>
                                    </a>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="sharenavbarDropdown">
                                        ...
                                        <a class="dropdown-item"  onclick="showCopy()">
                                            <svg width="20" height="10" viewBox="0 0 20 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M15 0H12C11.45 0 11 0.45 11 1C11 1.55 11.45 2 12 2H15C16.65 2 18 3.35 18 5C18 6.65 16.65 8 15 8H12C11.45 8 11 8.45 11 9C11 9.55 11.45 10 12 10H15C17.76 10 20 7.76 20 5C20 2.24 17.76 0 15 0ZM6 5C6 5.55 6.45 6 7 6H13C13.55 6 14 5.55 14 5C14 4.45 13.55 4 13 4H7C6.45 4 6 4.45 6 5ZM8 8H5C3.35 8 2 6.65 2 5C2 3.35 3.35 2 5 2H8C8.55 2 9 1.55 9 1C9 0.45 8.55 0 8 0H5C2.24 0 0 2.24 0 5C0 7.76 2.24 10 5 10H8C8.55 10 9 9.55 9 9C9 8.45 8.55 8 8 8Z" fill="#5B5C5C"></path>
                                            </svg>
                                            Copy Link
                                        </a>
                                        <a class="dropdown-item" >
