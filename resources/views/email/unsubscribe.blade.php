    ...
    <div style="max-width:600px;margin-top:0;margin-bottom:0;margin-right:auto;margin-left:auto;">
      <table align="center" cellpadding="0" style="border-spacing:0;font-family:'Muli',Arial,sans-serif;color:#{{$data['surfacetext_iconcolor']}};Margin:0 auto;width:100%;max-width:460px;">
        <tbody>
                  ...
                  <tr>
                    <td class="inner contents center" style="padding-top: 17px;padding-bottom:8px;padding-right: 13px;padding-left: 13px;text-align:left;">
                      <center>
                        ...
                        <p class="description center" style="font-family:'Roboto', sans-serif;Margin:0;text-align: left;max-width: 100%;line-height:21px;Margin-bottom:30px; font-size: 16px margin-left: auto;margin-right: auto; color: #{{$data['surfacetext_iconcolor']}};">You recently canceled your {!! $data['productname'] !!} subscription. You can still use credits for the remainder of your subscription. Thank you for being with us.</span></p>
                      
					   <p class="h1 center" style="padding-bottom: 7px;Margin:0;text-align:center;font-family:'Roboto', sans-serif;font-weight: 700;font-size: 16px;line-height: 21px;color: #{{$data['surfacetext_iconcolor']}};">Subscription expires at</p>
					   <p class="h1 center" style="padding-bottom: 15px;Margin:0;text-align:center;font-family:'Roboto', sans-serif;font-weight: 700;font-size: 16px;line-height: 21px; color: #{{$data['surfacetext_iconcolor']}};">{{$data['exp_date']}}</p>
                        </center>
                    </td>
                  </tr>
                </tbody>
          ...
          <!-- Social Media -->
          <tr>
            <td align="center" style="padding-bottom:0;padding-right:0;padding-left:0;padding-top: 13px;font-size: 12px;" valign="middle"><span class="sg-image" ><a style="text-decoration: none;color: #{{$data['hyperlink']}};line-height: 11px;font-weight: 300;" href="{{$data['siteurl']}}/privacypolicy" target="_blank">Privacy Policy</a></span>
          ...
          <tr>
            <td style="padding-top:0;padding-bottom:0;padding-right:30px;padding-left:30px;text-align:center;Margin-right:auto;Margin-left:auto;">
              <center>
                <p style="font-family:'Roboto', sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;color: #{{$data['bgtext_iconcolor']}};font-weight: 300;font-size: 12px;line-height: 11px;"><span >{{ $data['vchsitename'] }}</span> All rights reserved.
                </p>
              </center>
            </td>
          </tr>
