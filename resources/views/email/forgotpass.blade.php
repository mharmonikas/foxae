                  ...
                  <tr>
                    <td class="inner contents center" style="padding-top: 17px;padding-right: 13px;padding-left: 13px;text-align:left;">
                      <center>
                        ...
                        <p class="description center" style="font-family:'Roboto', sans-serif;Margin:0;text-align: left;max-width: 100%;line-height:14.7px;Margin-bottom:10px;margin-left: auto;margin-right: auto;"><span style="color:#{{$data['surfacetext_iconcolor']}}; font-family: 'Roboto', sans-serif; font-size: 16px;font-weight: 400; text-align: center; line-height:20px;">Your <span style="font-weight: 700 !important"> {{ $data['vchsitename'] }}</span> account password can be reset by clicking the button below. If you did not request a new password, please ignore this email.</span></p>
                        <span class="sg-image" ><a href="{{$data['siteurl']}}/reset-password/{{ $data['userid'] }}" target="_blank" style="border-width: 0px;margin-top: 26px;margin-bottom: 45px;width: 226px;text-decoration: none;background: #{{$data['primary_color']}};color: #{{$data['primarytext_iconcolor']}};border-radius: 0;padding: 9px 0;display: block;font-size: 18px;font-weight: 700;">Reset Password</a></span>
                        </center>
                    </td>
                  </tr>
                </tbody>
