...
<div class="container-fluid" id="pricing" >
	<div class="row fluid-row  new_pricing">
		...
		<div class="custom-price-apply">
			<input type="text" name="apply_coupon" id="apply_coupon_price" placeholder="Discount Code">
		...
		<div class="pricing_last_section">
			<p>Choose the payment plan that best suit your needs!</p>
			<p>Early cancelation fee may apply</p>
		</div>		
