(function() {
    ...
    (i = function() {
        ...
        return t.prototype.set_default_values = function() {
			...
			var strval = this.default_text;
			var resval = strval.replace(" ", "_");

            return '<ul class="chosen-choices">\n  <li class="search-field">\n    <input class="chosen-search-input ' + resval + '" type="text" autocomplete="off" value="' + this.default_text + '" />\n  </li>\n<li class="no-results">\n ' + '<a href="javascript:void(0);" class="addcategory btn btn-primary">Save</a>' + ' <span>' + this.escape_html(t) + '</span>\n</li>\n</ul>\n<div class="chosen-drop">\n  <ul class="chosen-results"></ul>\n</div>'
